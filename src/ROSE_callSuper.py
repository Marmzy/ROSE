...
from src.superenhancers.output import convert_stitched_to_bed, hockey_stick_plot, write_enhancer_table
...
def get_super(
    ...
    for bam in rankBy.columns:
        ...
        super_status = [
            1 if sr in superEnhancerRows else 0 for sr in range(0, len(stitched_regions))
        ]
